...
for i=1:I+1   
for j=1:J+1
U(i,j,1)=max(0,(i-1)*ds-K);  %%t=T=1/n=1
end
end
...
for j=2:J   %%算到了  J-1,还有一个J，是边界条件   I J都表示最后一个
for i = 2:I
...
plot(kapa,price,'-*');
title(' Option  prices  for different \kappa','fontsize',16,'FontWeight','bold')
xlabel('\kappa','fontsize',14,'FontWeight','bold');
